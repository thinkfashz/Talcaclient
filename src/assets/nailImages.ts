...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 1100" role="img" aria-label="${xml(title)}">
  <defs>
    ...
    <linearGradient id="skin-${id}" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#f7c8ad"/><stop offset="0.55" stop-color="#eab08d"/><stop offset="1" stop-color="#c98764"/></linearGradient>
