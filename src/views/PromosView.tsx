    ...
    >
      <div className="text-center space-y-3">
        ...
        <p className="font-sans text-[14px] md:text-base text-stone-400 max-w-lg mx-auto leading-relaxed">
          Paquetes selectos con imágenes internas estables para que se vean bien al desplegar en Cloudflare Pages.
        </p>
      </div>
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 w-full p-6 md:p-10 z-20 flex flex-col items-start gap-3 md:gap-4">
          ...
          <div className="w-full md:w-auto flex flex-col sm:flex-row gap-2.5 md:gap-3.5 mt-2">
            <button onClick={() => setActiveTab('agenda')} className="btn-primary font-bold text-xs uppercase tracking-wider h-12 px-8 rounded-xl cursor-pointer">
              Agendar con 20% OFF
            </button>
            <button onClick={() => setActiveTab('gallery')} className="glass-card text-white hover:text-stone-300 border-white/5 font-bold text-xs uppercase tracking-wider h-12 px-8 rounded-xl cursor-pointer hover:border-white/20 transition-all bg-white/[0.02]">
              Explorar Diseños
            </button>
          </div>
        </div>
