      ...
      >
        <defs>
          ...
          <linearGradient id="skin-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#edd1c4" />
            <stop offset="25%" stopColor="#f5e0d3" />
            <stop offset="50%" stopColor="#fffcf8" />
            <stop offset="75%" stopColor="#f5e0d3" />
            <stop offset="100%" stopColor="#edd1c4" />
          </linearGradient>
